...
start  cmd /k "artillery run ./test/artillery/stress-testing/stock-changeloca.yml"
start /WAIT cmd /k "artillery run ./test/artillery/stress-testing/stock-changelocb.yml"
...
start cmd /k "artillery run ./test/artillery/stress-testing/stock-group.yml"
start /WAIT cmd /k "artillery run ./test/artillery/stress-testing/stock-ungroup.yml"
...
start cmd /k "artillery run ./test/artillery/stress-testing/stock-create.yml"
start /WAIT cmd /k "artillery run ./test/artillery/stress-testing/stock-divide.yml"
...
start /WAIT cmd /k "artillery run ./test/artillery/stress-testing/stock-update.yml"
...
start /WAIT cmd /k "artillery run ./test/artillery/stress-testing/stock-get.yml"
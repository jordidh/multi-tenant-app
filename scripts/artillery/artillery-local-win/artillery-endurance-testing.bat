...
start  cmd /k "artillery run ./test/artillery/endurance-testing/stock-changeloca.yml"
start /WAIT cmd /k "artillery run ./test/artillery/endurance-testing/stock-changelocb.yml"
...
start cmd /k "artillery run ./test/artillery/endurance-testing/stock-group.yml"
start /WAIT cmd /k "artillery run ./test/artillery/endurance-testing/stock-ungroup.yml"
...
start cmd /k "artillery run ./test/artillery/endurance-testing/stock-create.yml"
start /WAIT cmd /k "artillery run ./test/artillery/endurance-testing/stock-divide.yml"
...
start /WAIT cmd /k "artillery run ./test/artillery/endurance-testing/stock-update.yml"
...
start /WAIT cmd /k "artillery run ./test/artillery/endurance-testing/stock-get.yml"